...
public abstract class CameraActivity extends AppCompatActivity
  ...
  //Add chmode: Check GPS connected or not
  protected int chmode;
  protected float nCurrentSpeed = 0;
  ...
  //dostuff will check if GPS is connected then update speed else not
  ...
  private void updateSpeed(CLocation location) {
    ...
    //Calculate Speed into Km/h or miles/h
...
//  }
  ...
  //Add a Variable
  protected abstract void processImage(float nCurrentSpeed);
